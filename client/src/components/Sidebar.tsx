      ...
      <nav className="mt-4">
        <ul className="space-y-1">
            ...
            <li key={item.path}>
              <Link href={item.path}>
                <a className={cn(
                  ...
                  location === item.path 
                    ? "text-white bg-secondary bg-opacity-20 border-l-4 border-secondary" 
          ...
          <li>
            <button 
              onClick={logout}
              className="w-full flex items-center px-4 py-3 text-gray-300 hover:bg-secondary hover:bg-opacity-10 hover:border-l-4 hover:border-secondary"
            >
              <span className="w-6">
              ...
              <span className={cn("ml-2", !open && "hidden")}>Logout</span>
            </button>
          </li>
        </ul>
      </nav>
